<%-- 
    Document   : Dashboardlogin
    Created on : Jul 22, 2018, 6:12:27 PM
    Author     : admin
--%>
...
<script src="https://code.jquery.com/mobile/1.4.5/jquery.mobile-1.4.5.min.js"></script>
    ...
    <h1 style="font-family:Fiolex Girls; font-size:400%;text-align:center; color:red ">Find Your Love</h1>
      ...
      String emaildl=request.getParameter("emaill");
      Class.forName("oracle.jdbc.driver.OracleDriver");
                Connection con1=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","system","system");
                  PreparedStatement stmt1=con1.prepareStatement("select * from profile where email='"+emaildl+"'");
    ...
    %>
    <form action="Dashboardlogin.jsp">
